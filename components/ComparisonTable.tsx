...
const TABLE_DATA = [
  { symbol: 'BDC', name: 'BodeCoin', color: '#10b981', aporte: 1000, qtd: 76394.3245, roi: '540.67%', icon: '/favicon (1).png' },
  { symbol: 'SOL', name: 'Solana', color: '#14F195', aporte: 1000, qtd: 7.8423, roi: '540.67%', icon: 'https://assets.coingecko.com/coins/images/4128/small/solana.png' },
  { symbol: 'ETH', name: 'Ethereum', color: '#F97316', aporte: 1000, qtd: 0.3428, roi: '540.67%', icon: 'https://assets.coingecko.com/coins/images/279/small/ethereum.png' },
  { symbol: 'BTC', name: 'Bitcoin', color: '#FFC107', aporte: 1000, qtd: 0.0112, roi: '540.67%', icon: 'https://assets.coingecko.com/coins/images/1/small/bitcoin.png' },
];
            ...
            return (
              <tr key={row.symbol} className={`hover:bg-white/5 transition-colors group ${isOrange ? 'bg-orange-500/5' : (isGreen ? 'bg-emerald-500/5' : (isYellow ? 'bg-gold/5' : ''))}`}>
                <td className="p-5 flex items-center gap-2">
                  <img src={row.icon} alt={row.symbol} className="w-5 h-5 rounded-full object-cover" />
